...
export const Newsletter = ({ subject, content, unsubscribeUrl }) => (
  <Html lang="en">
      ...
      <PortableText
        ...
        components={{
          block: {
            ...
            h2: ({ children }) => (
              <h2 style={{ fontSize: "20px", fontWeight: "bold", margin: "16px 0 8px" }}>
                {children}
              </h2>
            ),
            normal: ({ children }) => (
              <p style={{ fontSize: "16px", lineHeight: "24px", margin: "0 0 12px" }}>
                {children}
              </p>
            ),
          },
