      ...
      <div className="w-full h-full bg-white rounded-[10px] p-[20px] flex flex-col gap-[10px]">
        <div className="flex justify-end">
          <span
            ...
            className="border border-solid rounded-[5px] p-[5px] text-[20px]"
          >
            {service.icons}
          </span>
        </div>
        ...
        <div className="flex flex-col gap-[10px] px-[10px]">
          <h1 className="font-semibold text-[15px] text-[#008080]">
            {service.service}
          </h1>
          <p className="text-[#7a7a7a] text-[13px]">{service.description}</p>
