...
export const graduates = [
  { id: 1, image: "/graduate1.jpg" },
  { id: 2, image: "/graduate2.jpg" },
  { id: 3, image: "/graduate3.jpg" },
  { id: 4, image: "/graduate4.jpg" },
  { id: 5, image: "/graduate5.jpg" },
];
...
export const coreServices = [
  {
    ...
    description:
      "Empowering individuals, organizations, and systems with the knowledge and skills to use data effectively with programs through Data Science Bootcamps, AI for Public Health and Dvelopment Training, Monitoring and Evaluation (M&E) Training Workshops and Data Science Fellowship and Mentorship Programs.",
  },
  {
    icons: <MdWorkOutline />,
    color: "orange",
    service: "Monitoring, Evaluation & Learning (MEL)",
    description: "Designing, implementing, and enhancing M&E systems for evidence-based decision-making. ",
  },
  {
    icons: <FaChalkboardTeacher />,
    color: "grey",
    service: "Research, Policy & Advocacy Support",
    description: "Connecting evidence to action through applied research and policy influence.",
  },
  {
    icons: <GrCertificate />,
    color: "skyblue",
    service: "Data Science, AI & Innovation",
    description: "Leveraging modern analytics and AI to solve complex data challenges.",
  },
  {
    icons: <RiUserStarLine />,
    color: "indigo",
    service: "Advanced Analytics & Modelling",
    description: "Applying modeling and forecasting to optimize health interventions and resource planning",
  },
  {
    icons: <FaLaptop />,
    color: "pink",
    service: "Data Storytelling & Strategic Communication",
    description: "Translating data into compelling narratives that influence action and funding. Creating Interactive Dashboards, CUstom Data Visualizations for Repors and Presentations, Data-Driven Advocacy Tools and Story Maps, Donor Report Automation, Policy-Focused Data B ",
  },
];