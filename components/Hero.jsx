...
const Hero = () => {
  ...
  return (
    <div className="lg:h-screen sm:h-[1000px] h-[600px] lg:bg-cover bg-contain bg-no-repeat bg-[#ffffff] bg-fixed my-background p-[10px]">
      <div className="max-w-screen-xl hero flex lg:justify-between justify-center items-center lg:flex-row sm:flex-row flex-col lg:px-[60px] sm:px-[30px] px-[15px] h-full my-[20px]">
